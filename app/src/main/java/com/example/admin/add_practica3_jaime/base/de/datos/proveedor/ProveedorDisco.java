package com.example.admin.add_practica3_jaime.base.de.datos.proveedor;
...
import com.example.admin.add_practica3_jaime.base.de.datos.Ayudante;
...
public class ProveedorDisco extends ContentProvider {
    ...
    static{
        ...
        convierteUri2Int.addURI(Contrato.TablaDisco.AUTHORITY, Contrato.TablaDisco.TABLADISCO, DISCO);//Le damos la instrucción de qué hacer a la URI
        convierteUri2Int.addURI(Contrato.TablaDisco.AUTHORITY, Contrato.TablaDisco.TABLADISCO + "/#", DISCO_ID);
    }
